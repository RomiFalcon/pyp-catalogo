...
window.PYP_CATALOG = {
  ...
  products: [
    // ---- Panificados ----
    { id: "mm-integral", cat: "panificados", brand: "Masa Madre", name: "Pan de Masa Madre Integral", img: R("assets/catalog-pub/masamadre-integral.png"), desc: "Fermentación natural, miga húmeda y corteza rústica.", tags: ["Artesanal", "Integral"], price: 4700 },
    { id: "mm-salvado", cat: "panificados", brand: "Masa Madre", name: "Pan de Masa Madre con Salvado", img: R("assets/catalog-pub/masamadre-salvado.png"), desc: "Salvado de trigo, más fibra y sabor.", tags: ["Artesanal", "Con fibra"], price: 4700 },
    { id: "mm-aleman", cat: "panificados", brand: "Masa Madre", name: "Pan Tipo Alemán", img: R("assets/catalog-pub/masamadre-aleman.png"), desc: "Denso y nutritivo, ideal para fiambres.", tags: ["Artesanal"], price: 4700 },
    { id: "mm-calabaza", cat: "panificados", brand: "Masa Madre", name: "Pan de Molde Calabaza", img: R("assets/catalog-pub/masamadre-calabaza.png"), desc: "Pan de molde de masa madre con calabaza y avena.", tags: ["Artesanal"], price: 4700 },
    { id: "mm-semillas", cat: "panificados", brand: "Masa Madre", name: "Pan de Molde Semillas Andinas", img: R("assets/catalog-pub/masamadre-semillas-andinas.png"), desc: "Pan de molde de masa madre con semillas andinas.", tags: ["Artesanal"], price: 4700 },
    { id: "mm-centeno", cat: "panificados", brand: "Masa Madre", name: "Pan de Molde Centeno", img: R("assets/catalog-pub/masamadre-centeno.png"), desc: "Pan de molde de masa madre de centeno.", tags: ["Artesanal"], price: 4700 },
    { id: "mm-multicereal", cat: "panificados", brand: "Masa Madre", name: "Pan de Molde Multicereal", img: R("assets/catalog-pub/masamadre-multicereal.png"), desc: "Pan de molde de masa madre con mix de cereales y semillas.", tags: ["Artesanal"], price: 4700 },
    { id: "mm-parmesanitas", cat: "panificados", brand: "Masa Madre", name: "Parmesanitas", img: R("assets/catalog-pub/masamadre-parmesanitas.png"), desc: "Crackers de masa madre con queso, para picar.", tags: ["Artesanal", "Para picar"], price: 3500 },
    ...
    { id: "to-pizzetas", cat: "panificados", brand: "Tomatito", name: "Pizzetas de Tomate", img: R("assets/catalog-pub/tomatto-pizzetas.png"), desc: "Pizzetas de tomate listas para hornear. Vienen en paquete de 12 unidades.", tags: ["x12"], price: 1850 },

    // ---- Galletas Mom's ----
    { id: "mo-surtidas", cat: "galletas", brand: "Mom's", name: "Galletas de Avena Surtidas", img: R("assets/catalog-pub/moms-variedades-hq.webp"), desc: "Caja de 10 unidades surtidas: chocolate, mix de frutos secos, cacao y naranja, crumble de coco y arándanos.", tags: ["Plant based", "Caja x10 surtida"], price: 12750 },
    { id: "mo-avena", cat: "galletas", brand: "Mom's", name: "Galletas de Avena", img: R("assets/catalog-pub/moms-variedades-hq.webp"), desc: "Caja de 10 unidades del mismo sabor. Elegí el sabor.", tags: ["Plant based", "Caja x10"], price: 12750, variants: ["Chocolate", "Mix de frutos secos", "Cacao y Naranja", "Crumble de Coco", "Arándanos"] },
    ...
    { id: "rk-pochoclo", cat: "snacks", brand: "Rakan", name: "Pochoclo", img: R("assets/catalog-pub/rakan-pochoclo.jpeg"), desc: "Pochoclo liviano, 150 g. Ideal para el mostrador.", tags: ["Para picar", "150 g"], price: 3200 },
    ...
    { id: "mm-talitas", cat: "snacks", brand: "Masa Madre", name: "Talitas Masa Madre", img: R("assets/catalog-pub/masamadre-talitas.webp"), desc: "Crackers artesanales de masa madre, 150 g. Elegí el sabor.", tags: ["Artesanal", "150 g"], price: 3000, variants: ["Clásica", "Rúcula-Parmesano", "Tomate-Albahaca", "Multicereal", "Pizza", "Cúrcuma-Pimienta", "Orégano", "Queso-Cebolla", "Calabaza-Curry", "Pimentón", "Queso", "Integral", "Romero-Aceituna"] },
    { id: "mm-fajitas", cat: "snacks", brand: "Masa Madre", name: "Fajitas Masa Madre", img: R("assets/catalog-pub/masamadre-fajitas.webp"), desc: "Fajitas artesanales de masa madre, 100 g. Elegí el sabor.", tags: ["Artesanal", "100 g"], price: 2200, variants: ["Clásica", "Pimentón", "Queso"] },
