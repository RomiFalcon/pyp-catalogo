...
window.PYP_CATALOG = {
  ...
  products: [
    ...
    { id: "mo-avena", cat: "galletas", brand: "Mom's", name: "Galletas de Avena", img: R("assets/catalog-pub/moms-variedades-hq.webp"), desc: "Caja de 10 unidades del mismo sabor. Elegí el sabor.", tags: ["Plant based", "Caja x10"], variants: ["Chocolate", "Coco", "Granola", "Arándanos", "Mix de frutos secos", "Pasas de uva", "Maní con chocolate", "Cacao y naranja", "Limón", "Chocolate blanco"] },
    { id: "mo-proteicas", cat: "galletas", brand: "Mom's", name: "Galletas Proteicas", img: R("assets/catalog-pub/moms-proteicas-hq.webp"), desc: "Caja de 10 unidades del mismo sabor. 12 g de proteína por galleta, 100% vegano. Elegí el sabor.", tags: ["Proteica", "12g proteína", "Vegano", "Caja x10"], variants: ["Black", "Dubai", "Lemon Pie", "Choco blanco y arándanos", "Chocolate y nuez"] },
    { id: "mo-proteicas-surtidas", cat: "galletas", brand: "Mom's", name: "Galletas Proteicas Surtidas", img: R("assets/catalog-pub/moms-proteicas-hq.webp"), desc: "Caja de 10 unidades surtidas: Black, Dubai, Lemon Pie, Choco blanco y arándanos, Chocolate y nuez.", tags: ["Proteica", "12g proteína", "Vegano", "Caja x10 surtida"] },
    ...
    { id: "no-mani", cat: "snacks", brand: "Nötter", name: "Maní con Cobertura", img: R("assets/catalog-pub/notter-mani-surtido.webp"), desc: "Paquete de 200 g con 10 unidades surtidas: sabor salame, pizza, jamón y queso.", tags: ["Para picar", "200 g", "x10 surtido"] },
    ...
    { id: "ac-ddl", cat: "dulces", brand: "AC Artesanal", name: "Pastafrola Sabor Dulce de Leche", img: R("assets/catalog-pub/ac-frola-ddl-new.webp"), desc: "Relleno de dulce de leche, 100% calidad artesanal.", tags: ["Artesanal"] },
    ...
    { id: "ac-batata", cat: "dulces", brand: "AC Artesanal", name: "Pastafrola Sabor Batata", img: R("assets/catalog-pub/ac-frola-batata.webp"), desc: "Masa artesanal rellena con dulce de batata. Sin conservantes.", tags: ["Artesanal", "Sin conservantes"] },
    { id: "ac-membrillo-choco", cat: "dulces", brand: "AC Artesanal", name: "Pastafrola Membrillo y Chocolate", img: R("assets/catalog-pub/ac-frola-membrillo-chocolate.webp"), desc: "Relleno de membrillo con hilos de chocolate. Sin conservantes.", tags: ["Artesanal", "Sin conservantes"] },
    ...
    { id: "ya-pepas-frutilla", cat: "dulces", brand: "Yaiza", name: "Pepas Yaiza Dulce de Frutilla", img: R("assets/catalog-pub/yaiza-pepas-frutilla.webp"), desc: "Galletitas sabor vainilla, rellenas con dulce de frutilla.", tags: ["Artesanal"] },
    ...
    { id: "il-pepas-durazno", cat: "dulces", brand: "Il Cuoco", name: "Pepas Il Cuoco Avena y Algarroba con Duraznos", img: R("assets/catalog-pub/ilcuoco-pepas-durazno-algarroba.webp"), desc: "Pepas de avena y algarroba rellenas con mermelada de duraznos, 250 g.", tags: ["Artesanal", "250 g"] },
    { id: "il-pepas-membrillo", cat: "dulces", brand: "Il Cuoco", name: "Pepas Artesanales Il Cuoco Membrillo, Sésamo y Lino", img: R("assets/catalog-pub/ilcuoco-pepas-membrillo.webp"), desc: "Pepas de harina integral y avena con mermelada de membrillos y semillas de sésamo y lino, 250 g.", tags: ["Artesanal", "250 g"] },
    { id: "il-pepas-membrillo-algarroba", cat: "dulces", brand: "Il Cuoco", name: "Pepas Il Cuoco Integral y Algarroba con Membrillo", img: R("assets/catalog-pub/ilcuoco-pepas-membrillo-algarroba.webp"), desc: "Pepas de harina integral y algarroba rellenas con mermelada de membrillos, 250 g.", tags: ["Artesanal", "250 g"] },
    { id: "ot-cuadrados", cat: "dulces", brand: "On Track", name: "Cuadrados sin TACC", img: R("assets/catalog-pub/ontrack-cuadrados-hq.webp"), desc: "Caja surtida de 12 unidades libres de gluten, 80 g c/u: tarta con mermelada de membrillo, tarta con coco rellena con dulce de leche, brownie con nuez.", tags: ["Sin TACC", "Caja x12 surtida"] },
    ...
    // ---- Alfajores ----
    { id: "ar-alfajor-caja12", cat: "alfajores", brand: "Arroyito", name: "Alfajores Arroyito Caja x12", img: R("assets/catalog-pub/arroyito-alfajores-variedades.webp"), desc: "Caja de 12 unidades del mismo sabor. Elegí la variedad.", tags: ["Artesanal", "Caja x12"], variants: ["Bomba", "Dinámico", "Molotov"] },
    { id: "ar-alfajor-surtidos", cat: "alfajores", brand: "Arroyito", name: "Alfajores Arroyito Caja x12 Surtidos", img: R("assets/catalog-pub/arroyito-alfajores-variedades.webp"), desc: "Caja de 12 unidades surtidas: Bomba, Dinámico y Molotov.", tags: ["Artesanal", "Caja x12 surtida"] },
